...
Agent (`scan`, chaining httpx, subfinder, amass, theHarvester, gau,
...
behind one CLI, orchestrated by an LLM router that works with either a
cloud provider or a local model (Ollama).
